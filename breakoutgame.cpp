...
//                 {
//                     float pos = *(float*)event.packet->data;
//                     paddle2->SetX(pos);
//                 }
...
// // 同步状态给客户端（每2帧发一次）
// static int sendStateCounter = 0;
// sendStateCounter++;
// if (sendStateCounter % 3 == 0) {
//     SendGameState();
// }
...
//     DrawText("mainMachine:control the bottom paddle", 10, 570, 20, WHITE);
...
void BreakoutGame::DrawGame() {
    ...
    DrawText("client has connected", 600, 570, 20, GREEN);
    // // 客户端连接状态
    // if (clientPeer) DrawText("client has connected", 600, 570, 20, GREEN);
    // else DrawText("waiting for client...", 600, 570, 20, RED);
